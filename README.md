...
- Batch ingest: import all videos in a selected directory, with optional Stage-1 heat generation
- Stage 2: review heat segments, threshold filtering, label interesting/uninteresting, undo labels
- Heat export: generate both JSON and CSV outputs for downstream clipping/merge workflows
